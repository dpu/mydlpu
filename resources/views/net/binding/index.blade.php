...
<div class="container">
    <div class="page">
        <div class="hd">
            <h1 class="page_title">网络自助绑定</h1>
        </div>
        <form action={{route('netBindingResult')}} method="post">
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__hd"><label class="weui-label">账号</label></div>
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="text" name="username" placeholder="请输入账号" required>
                    </div>
                </div>
                <div class="weui-cell">
